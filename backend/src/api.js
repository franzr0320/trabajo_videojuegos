...
// VIDEOJUEGOS_USUARIO 
// get all videojeugo_usuario
app.get('/api/videojuegos-usuario/:usuario_id', async (req, res) => {
  const videojuegos = await getAllVideojuegosUsuario(req.params.usuario_id);
  res.json(videojuegos);
});

// get one videojeugo_usuario
app.get('/api/videojuegos-usuario/:usuario_id/:id', async (req, res) => {
...
// create videojeugo_usuario
app.post('/api/videojuegos-usuario', async (req, res) => {
...
app.put('/api/videojuegos-usuario/:usuario_id/:id', async (req, res) => {
...
app.delete('/api/videojuegos-usuario/:usuario_id/:id', async (req, res) => {
