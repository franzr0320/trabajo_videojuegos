document.addEventListener("DOMContentLoaded", function () {
  ...
  const botonGuardarProgreso = document.getElementById("btn-guardar");
  ...
  // GUARDAR PROGRESO
  botonGuardarProgreso.addEventListener("click", function () {
  
    const usuarioID = localStorage.getItem("userId");
    const videojuegoID = botonGuardarProgreso.dataset.id;
    ...
    fetch("http://localhost:3000/api/progreso", {
      ...
      .catch(function (err) {
        ...
        alert("Hubo un problema al cargar el progreso.");
      });
